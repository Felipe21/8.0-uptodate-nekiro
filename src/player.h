...
class Player final : public Creature, public Cylinder
{
	public:
		...
		fightMode_t getFightMode() const; //agregado othire nostalrius defense formula
	...
	private:
		...
		int64_t earliestAttackTime = 0; //agregado othire/nost defense formula othire nostalrius
